    ...
    <div className="parser-error-boundary">
      <div className="error-header">
        ...
        <p className="error-description">
          We encountered an error while parsing your PokerStars hand history. This usually happens
          when the hand history format is unexpected or contains invalid data.
        </p>
      </div>
